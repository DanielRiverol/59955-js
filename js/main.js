...
const datos = [
  {
    ...
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/clase_1`,
  },
  {
    id: 2,
    nombre: "Control de flujos",
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/clase_2`,
  },
  {
    id: 3,
    nombre: "Bucles e iteraciones",
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/clase_3`,
  },
  {
    id: 4,
    nombre: "Funciones",
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/clase_4`,
  },
  {
    id: 5,
    nombre: "Objetos",
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/clase_5`,
  },
  {
    id: 6,
    nombre: "Arrays",
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/clase_6`,
  },
  {
    id: 7,
    nombre: "Funciones de orden Superior",
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/clase_7`,
  },
  {
    id: 8,
...
const afterClass = [
  {
    id: 1,
    nombre: "After ciclos",
    enlace: `https://github.com/DanielRiverol/${numeroComision}-js/tree/clases/after_ciclos`,
  },
  {
    id: 2,
  ...
  if (datos.length > 0) {
    datos.forEach((fila, index) => {
      ...
      nuevaFila.innerHTML = `
                <td>${fila.id}</td>
                <td>${fila.nombre}</td>
                <td><a href="${fila.enlace}" target="_blank">Clase ${
        index + 1
      }</a></td>`;
